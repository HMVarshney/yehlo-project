...
import {Grid, Card, CardContent, CardHeader, Button, Popover, Typography, LinearProgress, TextField} from '@material-ui/core'
...
class InputForm extends Component {
    ...
    render() {   
        return (
            <div>
                <Typography variant='h3' style={{fontFamily:'Pacifico', textAlign:'center'}}>Welcome</Typography>
                <img alt='BG' style={{position:'absolute', left:'0px', top:'0px', zIndex:-1, width:'100%', height:'85%'}} src='https://www.studentacco.com/e_images/homepage-banner-new.jpg' />
                <Grid container alignItems="center" justify="center">
                    <Grid item style={{marginTop:'30px'}} component={Card}>
                        
                        <Card variant='outlined' 
                            style={{height: '400px', width:'600px', backgroundColor: 'rgba(119,136,153,0.5)', padding: '20px'}}>
